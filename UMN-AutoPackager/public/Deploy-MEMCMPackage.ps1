function Deploy-MEMCMPackage {
    ...
    process {
# Fix the logic to use the new json structure
...
# check the value in the packageconfig overridePackagingTargets to determine where this data will come from
# Remove the application name logic. This should be generated by the set command
...
# Check the logic here make sure it is working with the new JSON logic
